...
#include "InteractableLoreItem.h"
...
// Sets default values
AInteractableLoreItem::AInteractableLoreItem()
{
...
void AInteractableLoreItem::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AInteractableLoreItem::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

bool AInteractableLoreItem::CheckInteraction()
{
	return bInteractionEnabled;
}

void AInteractableLoreItem::InteractWithMe()
{
	ShowDialogue();
}

void AInteractableLoreItem::ShowInteractionWidget()
{
	InteractionWidget->SetVisibility(true);
}

void AInteractableLoreItem::HideInteractionWidget()
{
	InteractionWidget->SetVisibility(false);
}

void AInteractableLoreItem::ShowDialogue()
{
...
void AInteractableLoreItem::RotateWidgetToCamera()
{
...
void AInteractableLoreItem::GetPlayerCharacter()
{
	APlayerController* PlayerController = UGameplayStatics::GetPlayerController(this, 0);
